...
const SecondInningsReducer = undoable(secondInnReducer, {
  filter: includeAction([
    MatchActionTypes.ADD_RUNS_INN_2,
    MatchActionTypes.WICKET_INN_2,
    MatchActionTypes.WIDEBALL_INN_2,
    MatchActionTypes.NOBALL_INN_2,
    MatchActionTypes.LOAD_STORAGE,
  ]),
});

export default SecondInningsReducer;
